...
<input type="password" name="confirmpass" class="form-control text" placeholder="enter confirm password" >
</div>
<div class="form-group">
<label>Address</label>
<textarea class="form-control" rows="6" name="address" placeholder="enter full address"></textarea>
</div>
<div class="form-group">
